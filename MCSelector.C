...
Bool_t *varHlt[] = {
  ...
  TH2D *hRecSel = new TH2D("hCandidates_vs_VeloClusters","Candidates vs Velo",
    0, 5, 10,
    2, 5, 6
    );
    GetOutputList()->Add( hRecSel );  

  TH2D *hPID = new TH2D("hCandidates_vs_VeloClusters","Candidates vs Velo",
    0, 5, 10,
    2, 5, 6
    );
    GetOutputList()->Add( hPID );  
...
void d0Selector::Terminate()
{
  ...
  TFile *outfile = TFile::Open("MC_effTable_1128.root","recreate");
